...
#define INIT_GENERATION_SIZE 8  // size of initial generation
#define NUM_OF_BEST_FIT 2       // number of best-fits that survive generations
#define MAX_GENERATIONS 20      // maximum number of generations of individuals to examine
#define MAX_STAGNATED_GENS 8    // maximum number of acceptable generations with stagnated performance
